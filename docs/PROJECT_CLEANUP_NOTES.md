...
- `external/VisionTasker/`, `external/models/`, `external/rag_templates/`: required local assets for replay, matching, and reuse.
...
- `external/models/` and `external/VisionTasker/pt_model/`.

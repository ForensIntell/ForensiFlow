...
class PagePerceptionFusionTests(unittest.TestCase):
    def test_extract_visiontasker_elements_flattens_blocks(self) -> None:
        payload = [
            "alignment: v",
            {
                "id": "b-0",
        ...
        elements = extract_visiontasker_elements(payload)
    ...
    def test_fuse_page_perception_merges_vertical_overlap(self) -> None:
        ...
        result = fuse_page_perception(
            vision_elements=extract_visiontasker_elements(vision),
        ...
        regions = [
            {
                ...
                "bounds": [0, 0, 100, 100],
                "y_range": [0, 100],
                "source_counts": {"xml": 1, "visiontasker": 1},
                "texts": {"combined": ["A"], "xml": ["A"], "visiontasker": ["A"]},
                "description": "A",
            }
        ]
